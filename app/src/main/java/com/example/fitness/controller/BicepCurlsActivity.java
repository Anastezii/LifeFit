...
public class BicepCurlsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_instructions=findViewById(R.id.description_Bicep_Curls);
        write_exercise=findViewById(R.id.button_Bicep_Curls);

        DatabaseReference exercisesRef = FirebaseDatabase.getInstance().getReference("Exercises/Top_part/Bicep Curls");
        exercisesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(BicepCurlsActivity.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        write_exercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference exerciseRef = FirebaseDatabase.getInstance().getReference("Exercises/Top_part/Bicep Curls");
                exerciseRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()) {
                            ...
                            try {
                                ...
                                Toast.makeText(BicepCurlsActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
                            }
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(BicepCurlsActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void writeNutritionDataToFirebase(ExerciseDataService exerciseData) {
        ...
        String key = "Bicep Curls";
        dbRef.child(key).setValue(exerciseData).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){

                    Toast.makeText(BicepCurlsActivity.this,"Exercise is added successfully!",
                            Toast.LENGTH_LONG).show();

                }else{
                    Toast.makeText(BicepCurlsActivity.this,"Something went wrong!",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
