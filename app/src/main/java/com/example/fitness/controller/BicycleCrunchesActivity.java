...
public class BicycleCrunchesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_instructions=findViewById(R.id.description_bicycle_crunches);
        write_exercise=findViewById(R.id.button_bicycle_crunches);

        DatabaseReference exercisesRef = FirebaseDatabase.getInstance().getReference("Exercises/Abs/Bicycle Crunches");
        exercisesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(BicycleCrunchesActivity.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        write_exercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference exerciseRef = FirebaseDatabase.getInstance().getReference("Exercises/Abs/Bicycle Crunches");
                exerciseRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()) {
                            ...
                            try {
                                ...
                                Toast.makeText(BicycleCrunchesActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
                            }
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(BicycleCrunchesActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void writeNutritionDataToFirebase(ExerciseDataService exerciseData) {
        ...
        String key = "Bicycle Crunches";
        dbRef.child(key).setValue(exerciseData).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){

                    Toast.makeText(BicycleCrunchesActivity.this,"Exercise is added successfully!",
                            Toast.LENGTH_LONG).show();

                }else{
                    Toast.makeText(BicycleCrunchesActivity.this,"Something went wrong!",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
