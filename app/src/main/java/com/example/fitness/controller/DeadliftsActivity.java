...
public class DeadliftsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exercisesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(DeadliftsActivity.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                exerciseRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()) {
                            ...
                            try {
                                ...
                                Toast.makeText(DeadliftsActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
                            }
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(DeadliftsActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void writeNutritionDataToFirebase(ExerciseDataService exerciseData) {
        ...
        String key = "Deadlifts";
        dbRef.child(key).setValue(exerciseData).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){

                    Toast.makeText(DeadliftsActivity.this,"Exercise is added successfully!",
                            Toast.LENGTH_LONG).show();

                }else{
                    Toast.makeText(DeadliftsActivity.this,"Something went wrong!",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
