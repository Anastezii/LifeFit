...
public class DinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinnner);

        grams=findViewById(R.id.gramms_dinner);
        foodSpinner=findViewById(R.id.spinner_dinner);
        add=findViewById(R.id.add_dinner);
        txt_calories=findViewById(R.id.show_calories_dinner);
        searchView = findViewById(R.id.searchViewDinner);
        ...
        reference.addValueEventListener(new ValueEventListener() {
                ...
                if (snapshot.exists() && snapshot.getChildrenCount() > 0) {
                    for (DataSnapshot foodSnapShot:snapshot.getChildren()){
                        try{
                            ...
                            Toast.makeText(DinnerActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
                        }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DinnerActivity.this,error.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
        ...
        nutritionDataRef.child(key).setValue(nutritionData).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(DinnerActivity.this,"Dinner is added successfully!",
                   ...
                   /* Intent intent=new Intent(DinnerActivity.this,FoodActivity.class);
                    ...
                    Toast.makeText(DinnerActivity.this,"Something went wrong!",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
