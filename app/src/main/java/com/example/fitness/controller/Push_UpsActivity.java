...
public class Push_UpsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_instructions=findViewById(R.id.description_Push_Ups);
        write_exercise=findViewById(R.id.button_Push_Ups);

        DatabaseReference exercisesRef = FirebaseDatabase.getInstance().getReference("Exercises/Top_part/Push-Ups");
        exercisesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Push_UpsActivity.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        write_exercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference exerciseRef = FirebaseDatabase.getInstance().getReference("Exercises/Top_part/Push-Ups");
                exerciseRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()) {
                            ...
                            try {
                                ...
                                Toast.makeText(Push_UpsActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
                            }
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(Push_UpsActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
        ...
        dbRef.child(key).setValue(exerciseData).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(Push_UpsActivity.this,"Exercise is added successfully!",
                            Toast.LENGTH_LONG).show();

                }else{
                    Toast.makeText(Push_UpsActivity.this,"Something went wrong!",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
