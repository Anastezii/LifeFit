...
public class TricepKickbacksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tricep_kickbacks);

        txt_instructions=findViewById(R.id.description_Tricep_Kickbacks);
        write_exercise=findViewById(R.id.button_Tricep_Kickbacks);

        DatabaseReference exercisesRef = FirebaseDatabase.getInstance().getReference("Exercises/Top_part/Tricep Kickbacks");
        exercisesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(TricepKickbacksActivity.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        write_exercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference exerciseRef = FirebaseDatabase.getInstance().getReference("Exercises/Top_part/Tricep Kickbacks");
                exerciseRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()) {
                            ...
                            try {
                                ...
                                Toast.makeText(TricepKickbacksActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
                            }
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(TricepKickbacksActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void writeNutritionDataToFirebase(ExerciseDataService exerciseData) {
        ...
        String key = "Tricep Kickbacks";
        dbRef.child(key).setValue(exerciseData).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){

                    Toast.makeText(TricepKickbacksActivity.this,"Exercise is added successfully!",
                            Toast.LENGTH_LONG).show();

                }else{
                    Toast.makeText(TricepKickbacksActivity.this,"Something went wrong!",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
